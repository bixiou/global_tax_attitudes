...
\begin{figure}[h!] 
  ...
  \makebox[\textwidth][c]{\includegraphics[width=.56\textwidth]{GDP_pc_PPP_fr.pdf}}% https://data.worldbank.org/indicator/NY.GDP.PCAP.PP.CD?contextual=default&end=2021&locations=EU-ZG-XD-XM-1W-IN-US-CD-BI-LU-CN&start=2021&view=bar
\end{figure}
...
\begin{figure}[b!] % PNON remove?
  ...
  {Heatplot_global_tax_attitudes_share_fr.pdf}}\label{fig:oecd} % with dependence on others (absent from OECD): Heatplot_burden_share_all_share_countries
...
\begin{figure}[h!]
  ...
  {gcs_support_positive.pdf}}\label{fig:gcs_support} 
\end{figure}
...
\begin{figure}[h!] 
  ...
  \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{conjoint_left_ag_b_binary_positive.pdf}} 
\end{figure}
...
\begin{figure}[h!]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=.92\textwidth]{emissions_par_region_sm.pdf}} % .92
\end{figure} 
...
\begin{figure}[bh!]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{GCP_trajectoires.pdf}} 
\end{figure} 
...
\input{scenarios_table_fr.tex} % PTET? étoffer
...
\begin{subfigure}{.5\textwidth}
  ...
  \includegraphics[width=\textwidth]{gcp_var_rev_rich_only.pdf}
\end{subfigure}
...
\begin{figure}[h]
  ...
  \centerline{
    \includegraphics[width=.8\paperwidth]{share_below_global_mean.pdf}
    } 
...
\begin{figure}[h]
  ...
  \centerline{\includegraphics[width=.8\paperwidth]{gain_adj_2030_fr.pdf}} % mean_gain_over_gdp_2019 mean_gain_2030
\end{figure}
...
\begin{sidewaysfigure}
  ...
  \centerline{\includegraphics[width=.9\paperheight]{npv_over_gdp_gcs_adj_fr.pdf}
...
\begin{figure}[h!]
  ...
  \centerline{\includegraphics[width=.85\paperwidth]{Soptimistic_npv_over_gdp_gcs_adj_fr.pdf}} 
\end{figure}
\begin{figure}[b!]
  ...
  \centerline{\includegraphics[width=.85\paperwidth]{Scentral_npv_over_gdp_gcs_adj_fr.pdf}
    } 
\end{figure}
% \begin{figure}[b!]
...
%   \centerline{\includegraphics[width=.84\paperwidth]{npv_over_gdp_gcs_adj_fr.pdf}
%     } % mean_gain_over_gdp_2019
