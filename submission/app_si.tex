...
\resizebox*{!}{.73\textheight}{ % 73 is the max when there is a title
        \input{../tables/country_comparison/gcs_support_ci.tex}
        }
    }
    {\footnotesize %\textit{Note}: 
    }
...
\begin{table}[h]\label{tab:gcs_support_understood}
    ...
    \makebox[\textwidth][c]{
% \resizebox*{!}{.73\textheight}{ % 73 is the max when there is a title
        \input{../tables/country_comparison/gcs_support_understood_ci.tex}
        }
    % }
    {\footnotesize %\textit{Note}: 
    }
...
\begin{table}[h!]
    \caption{Sample representativeness of the global surveys -- High-income countries 1} \label{tab:sample_coposition_1}
    \makebox[\textwidth][c]{
        \scalebox{0.8}{
...
\begin{tabular}[t]{lrlrlrlrl}
    ...
    \begin{table}[h!]
    \caption{Sample representativeness of the global surveys -- High-income countries 2}
    \makebox[\textwidth][c]{
        \scalebox{0.8}{
...
\begin{tabular}[t]{lrlrlrlrl}
    ...
    \begin{table}[h!]
    \caption{Sample representativeness -- High-income countries 3}
    \makebox[\textwidth][c]{
        \scalebox{0.8}{
...
\begin{tabular}[t]{lrlrlrlrl}
    ...
    \begin{table}[h!]
    \caption{Sample representativeness -- Middle-income countries 1}
    \makebox[\textwidth][c]{
        \scalebox{0.8}{
...
\begin{tabular}[t]{lrlrlrlrl}
    ...
    \begin{table}[h!]
    \caption{Sample representativeness -- Middle-income countries 2}
        \makebox[\textwidth][c]{
            \scalebox{0.8}{
...
\begin{table}[h]\label{tab:attrition_US1}
    ...
    \makebox[\textwidth][c]{
\resizebox*{!}{.73\textheight}{ % 73 is the max when there is a title
        \input{../tables/US1/attrition_analysis_vote_ci.tex}
        }
    }
    {\footnotesize %\textit{Note}: 
    }
...
\begin{table}[h]\label{tab:attrition_US2}
    ...
    \makebox[\textwidth][c]{
\resizebox*{!}{.73\textheight}{ % 73 is the max when there is a title
        \input{../tables/US2/attrition_analysis_vote_ci.tex}
        }
    }
    {\footnotesize %\textit{Note}: 
    }
...
\begin{table}[h]\label{tab:attrition_EU}
    ...
    \makebox[\textwidth][c]{
\resizebox*{!}{.73\textheight}{ % 73 is the max when there is a title
        \input{../tables/EU/attrition_analysis_vote_ci.tex}
        }
    }
    {\footnotesize %\textit{Note}: 
    }
...
\resizebox*{!}{.72\textheight}{ % 73 is the max when there is a title
        \input{../tables/balance_analysis_ci.tex}
        }
    }
...
\begin{table}[h]\label{tab:placebo}
    ...
    \makebox[\textwidth][c]{
% \resizebox*{!}{.73\textheight}{ % 73 is the max when there is a title
        \input{../tables/placebo_tests_ci.tex}
        }
    % }
    {\footnotesize \textit{Note}: Standard errors are reported in parentheses.
    }
...
\begin{table}[h]
    ...
    \makebox[\textwidth][c]{\input{../tables/country_comparison/conjoint_c_wo_none_alla_ci.tex}}\label{tab:_alla}
...
\begin{table}[h]
    ...
    \makebox[\textwidth][c]{\input{../tables/ordering_us_ci.tex}}\label{tab:ordering_us}
