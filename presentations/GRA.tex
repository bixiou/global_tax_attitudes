% TODO! include figure on GDP per country
\documentclass[aspectratio=169,xcolor=dvipsnames, 11pt,mathserif]{beamer} 
\input{preamble_slides.tex}
\usepackage{multicol}
              
% Let me give you one figure: the GDP of high-income countries is 100 times greater than the GDP of low-income countries. This means that redistributing just 1% of income of the richest billion people would more than double the income of the poorest billion people. 
% At Global Redistribution Advocates, we support any policy redistributing resources from the Global North to the Global South which is supported by a majority in all countries. 
% Actually, representative surveys show that global redistribution is very popular. 70% of people in the world are willing to contribute 1% of their income to fight climate change. At Global Redistribution Advocates, we defend a Global Climate Plan. This Plan would put a cap global CO2 emissions, implemented through global carbon pricing, and financing a global basic income. This Plan would not only end global warming but also eradicate extreme poverty as each human would receive 50$/month.
% We also defend an international tax on millionaires to finance low-income countries. In every country, at least 70% of people support this proposal. When we ask Americans and Europeans what share of the revenues of a wealth tax should be allocated to low-income countries, the average person answers one third. 
% As discussions on a global wealth tax have started at the G20 thanks to the Brazilian presidency, it is crucial that such a tax is designed so that at least part of its revenues benefit low-income countries. 
% Academic surveys also show that political parties could gain vote intentions by campaigning on global redistribution. Our ambition is to foster a global coalition of policymakers, unions, civil society and celebrities in favor of one or several policy of global redistribution. If candidates around the world rally behind a common policy proposal, it would make their proposal credible and help them win the elections. In particular, an international coalition for global redistribution can revive hope in left-wing parties and defeat nationalist candidates in upcoming elections in the EU, in India, and in the U.S. 
% Our ask today is that Brazil leads such a coalition and invites policymakers throughout the world to endorse a flagship proposal such as a tax on millionaires to finance low-income countries. 
% We are Global Redistribution Advocates. For detail our work or to join forces, check out our Twitter or website.
...
\begin{center}
\begin{LARGE}
\textcolor{blue}{Global Redistribution:\\ \quad \\ Support and Proposals}
\end{LARGE}
...
\begin{frame}{Thee Global Climate Scheme\label{gcs_support}}
    % \bbsp \ip \blue{How can we guarantee an emissions trajectory in line with the carbon budget?}
    % \ip \quad A yearly \rose{cap on global emissions} \pause (or a global carbon price).
    % \ip Emissions permits should be tradable and auctioned to polluting firms upstream.
    % \ip \blue{How to allocate carbon pricing revenues?}
    % \ip \quad Simple focal point: an \rose{equal cash transfer} for all human adults.
    % \ip \quad This ``global basic income'' of \$30-50/month would alleviate extreme poverty. 
    % \ip \red{This} \rose{Global Climate Scheme} \red{garners majority support} in the 20 countries surveyed. \pause
    % \ee
\begin{figure}
    \centering 
    \caption{Do you support the Global climate scheme? \textit{Yes}/\textit{No} (Percentage of \textit{Yes})}
    \vspace{-.2cm}
    \includegraphics[width=.9\textwidth]{../figures/country_comparison/gcs_support_positive.pdf} 
\end{figure}
\end{frame}
...
\subsection{The Global Climate Plan}
...
\begin{frame}{The principles}
    \begin{enumerate}[<+->]
        ...
        \bbvsp \ip At their peak, GCP revenues at 2\% of world GDP, with 0.6\% of world GDP in international transfers. 
...
\begin{frame}{Scenarios with non-universal participation\label{scenarios_maps}}
    \begin{figure}
        ...
        \only<2>{ \caption{Generous EU scenario. \\ Distributive effects of the Global Climate Plan throughout the century.}
        \includegraphics[height=.8\textheight]{../figures/maps/Sgenerous_EU_npv_over_gdp_gcs_adj.pdf} }
...
\begin{frame}{The Global Wealth Tax}
    \bbvsp \ip Among voluntary countries:
    \ip \rose{Tax individual} net \rose{wealth}. 
    \ip Basic tax schedule: 2\% marginal tax rate above \$5 million, 6\% above \$100 million, 10\% above \$1 billion \\ ~$\Rightarrow$ 1.8\% of world GDP in revenues.
    \ip Each country is free to top this basic tax schedule with a more progressive one.
    \ip \rose{Half of the revenues allocated to lower-income countries}.\\ The poorer the country, the more it gets.
    \ee
\end{frame}
% TODO! revenu by country

% \subsection{The Global Climate Assembly}

\begin{frame}{The Global Climate Assembly}
    \bbvsp \ip Among voluntary countries:
    \ip \rose{Proportional elections} on global lists in a single world constituency.
    \ip The Assembly is \rose{consultative} and \blue{drafts treaties on climate change}.
    \ip One-off five-year experiment of global democratic governance.
    \ip ~$\Rightarrow$ Fosters a \blue{global public debate} on climate justice.
    \ee
\end{frame}

\begin{frame}{The call for global redistribution}
    \bbvsp \ip \rose{We urge world leaders to enact policies to end poverty, halt global warming, and reduce inequality.}
    \ip \blue{Enforceable tax system}: automatic exchange of information, global asset registry, fair corporate tax.
    \ip \blue{Inclusive financial system} with the Bridgetown 2.0 initiative: public guarantees on credit and foreign exchange, recapitalization of Multilateral Development Banks, debt restructuration, issuance of SDRs for low-income countries.
    \ip \blue{International taxation}: ultimately a Global Climate Plan, carbon taxes on shipping and aviation as first steps, Financial Transactions Tax, Global Wealth Tax.
    \ip \blue{Democratic global governance}: goal of directly elected UN Parliamentary Assembly with binding powers, experiment with consultative global assemblies, proportional representation.
    \ip ``We call on world leaders to examine global redistribution policies such as those outlined above at the UN, G20, and COPs. We urge policymakers to implement global policies redistributing at least \$1 trillion per year (i.e., 1\% of global income) from higher-income countries to lower-income countries. This would only be a first step towards a less unequal world.''
    \ee
\end{frame}

\begin{frame}{The Colombian proposal}
    \bbvsp \ip Minimum \rose{global tax on individual income and corporate income}.
    \ip \rose{Revenues finance} an Organization of International Taxation and \rose{global public goods} (climate action, vaccination, peacebuilding mission...)
    \ip The system of votes and vetoes remains to be defined.
    \ee
\end{frame}
...
\begin{frame}{Conjoint analyses: influence on preferred platform (Eu) \hyperlink{conjoint_r_uk}{\beamergotobutton{Go back}}\label{conjoint_r_eu}} 
	...
	\ip The effect of GCS is among the highest (wealth tax, better public services, higher minimum wage).
    \ee
\end{frame}% TODO! parties alliance
