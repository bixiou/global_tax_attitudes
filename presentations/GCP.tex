% TODO gcs_support by vote in each country
% TODO support for national vs. global carbon tax
...
% CC is a global pb
% Countries lack resources/capacity to address CC
% Countries lack incentive to join the club / tackle CC => what incentivize countries to join
% Many ponder over perceived lack of fairness

% Our GCP addresses these 4 key issues. 

% Elaboration on the concept: we put this to a test, here's what we told to respondents. Possibly surprisingly, there is strong support, even in the U.S.
...
\begin{frame}{International surveys with a focus on the West\label{questionnaires}}
    \bbvs
    \ip Global survey (02/2021--02/2022): 
    ...
    \ip Complementary surveys (01--04/2023): 
...
\ee \vspace{-.3cm}
    \begin{figure}
        ...
        \only<4>{\caption{Do you support...? \textit{Yes/No} (Percentage of \textit{Yes}) \hyperlink{gcs_perceptions}{\beamergotobutton{Perceptions}} \hyperlink{conjoint_ab}{\beamergotobutton{Complementary policies}} \hyperlink{gcs_vote}{\beamergotobutton{By vote}}}
        \includegraphics[height=.55\textheight]{../figures/country_comparison/support_binary_positive.pdf} } % 45
    \end{figure}
\end{frame}

\subsection{Stated support for other global redistribution policies}
...
\section{The Global Climate Plan (GCP)}
...
\begin{frame}{The trajectories}
    \begin{figure}
        \centering 
        \caption{Global trajectories estimated for the Global Climate Plan
        }
...
\begin{frame}{The distributive effects}
    \begin{figure}
        \centering 
        ...
        \only<2>{ \caption{Distributive effects of the Global Climate Plan throughout the century.}
...
\begin{frame}{We need you!}
    \begin{figure}
        \centering \caption{You liked the GCP? Read, share, endorse on \rose{global-redistribution-advocates.org}!}
...
\begin{frame}{Conjoint analyses: influence on preferred platform (US) \hyperlink{conjoint_r_fr}{\beamergotobutton{Go back}}\label{conjoint_r_us}} 
    \bbvs \ip \rose{Endorsing the GCS is not determinant to gain the Democratic primary.}
    \ee
    \begin{figure}\vspace{-.4cm}
        \centering 
