...
\begin{frame}{The principles}
    \begin{enumerate}
        ...
        \ee
        \item \blue{A glbal basic income that eradicates extreme poverty.}
        \bbvsp \ip At their peak, GCP revenues would be 5\% of world GDP, with 1\% of world GDP in international transfers. 
        \ip The basic income of $\approx$\$50 per month (in nominal) for each human above 15 would lift out of extreme poverty the 700 million people who live with less than \$2.15 a day (in PPP).
        \ee
...
\begin{frame}{The distributive effects (cc'ed)}
    
\end{frame}

\begin{frame}{Complement to others policies}
    \bbsp \ip Wealth tax
    \ip Other sources of funding  (e.g. a global corporate tax) to sustain the basic income in the long run.
    \ip National redistribution
    \ip Climate policies % some decarbonization costs can be mutualized, e.g. through public investments in public transportation and subsidies to thermal insulation, to reduce the discrepancy in private costs between people with similar income but different carbon footprint. 
    \ee
\end{frame}
