% TODO! add campaign effect; add representativeness
% TODO! encadrer en rouge des trucs
% TODO ajouter colonne pol dans Table vote ~ GCS
% TODO list exp mieux expliquer
% TODO liens de redirection checker (e.g. GCS by vote)
% TODO! add slide media campaign; table representativeness; determinants
...
\begin{center}
\begin{LARGE}
\textcolor{blue}{Majority support for global redistributive and climate policies}
\end{LARGE}
...
\begin{frame}{Representativeness of complementary surveys}
    \vspace{-.6cm}
\begin{table}[h!]
...
\begin{frame}{Representativeness of \textit{Eu} surveys}
    \vspace{-.6cm}
    \begin{table}[h]
...
\begin{frame}{Net gains from the Global Climate Scheme\label{GCS_gain}  \hyperlink{other_distributive}{\beamergotobutton{More maps}}}
    \begin{figure}
...
\begin{frame}{Conditions for increased foreign aid\label{foreign_aid_conditions} \hyperlink{foreign_aid_perceptions}{\beamergotobutton{Perceptions}}}
...
\begin{frame}{Preferences over public spending%How to fund increased foreign aid
	\label{} \hyperlink{foreign_aid_perceptions}{\beamergotobutton{Perceptions}}}
	\begin{columns}
...
\begin{frame}{Conjoint analyses: influence on preferred platform (France)\label{conjoint_r_fr} \hyperlink{conjoint_r_eu}{\beamergotobutton{EU}} \hyperlink{conjoint_r_us}{\beamergotobutton{U.S.}}} 
	\vspace{-.2cm}
...
\begin{frame}{Campaign effect\label{}}
	Presenting 3 pros and 6 cons or asking to reflect upon pros and cons reduces support. 
    \begin{table}[h]
...
\begin{frame}{Belief about the support\label{}}
	\bbvs \ip Beliefs on the support for the GCS are relatively accurate: \\ \quad \blue{no evidence of pluralistic ignorance in the U.S. \\ \quad an underestimation by 15-20 p.p. in Eu}.
    \ee \vspace*{-.4cm}
    \begin{figure}
        \centering 
...
\begin{frame}{Donation to Africans vs. fellow citizens\label{donation}}
    ...
    \begin{table}[h]\label{tab:donation}\vspace*{-.35cm}
      ...
      \end{table}
      $\Rightarrow$ \blue{U.S. non-voters and Trump voters donate 4 p.p. more to fellow citizens, others give the same amount.}
...
\ip 3. \rose{The mismatch between support and absence of global policies in the public debate remains unexplained} \textit{}
	\begin{itemize}
		\item Climate change and global poverty are seen as bigger issues than national inequality
...
\ip \blue{Alternative explanations for the mismatch are needed}
    \begin{itemize}
        \item National bias in power structures (elections, media)? %national framing by elections, media, or even sport?   and mental structures (hymns, sport teams)
        %$\Rightarrow$ How to test that?
        \item Pluralistic ignorance of the elites? $\Rightarrow$ Survey on european MPs and MEPs.
        \item Ideas whose time has come, and just lack some advocacy? \pause \\ $\Rightarrow$ \rose{\href{https://global-redistribution-advocates.org/sign-petitions}{global-redistribution-advocates.org/sign-petitions} }% Ideas largely accepted but rarely supported?
...
\begin{frame}{Support for increased foreign aid \hyperlink{foreign_aid_conditions}{\beamergotobutton{Go back}}\label{foreign_aid_perceptions}}\vspace{-.2cm} 
    \begin{figure} 
        \centering 
        \caption{Actual, perceived and preferred amount of foreign aid, with random info (or not) on actual amount. (\textit{Mean})}\vspace{-.2cm}
        \includegraphics[height=.4\textheight]{../figures/country_comparison/foreign_aid_amount_mean.pdf} % TODO: see median
...
\begin{frame}{Conjoint analyses: influence on preferred platform (Eu) \hyperlink{conjoint_r_fr}{\beamergotobutton{Go back}}\label{conjoint_r_eu}} 
    \begin{figure}\vspace{-.2cm}
        \centering 
        \caption{%Imagine that a [Left or Center-left coalition wins the next elections]. Here are two possible platforms on which [the coalition] may campaign (the policies in each platform are randomly drawn from a pool of credible [Left/Center-left] policies).\\
		(...) Even if you do not support the Left, which of these platforms do you prefer? 
...
\begin{frame}{Conjoint analyses: influence on preferred platform (U.S.) \hyperlink{conjoint_r_fr}{\beamergotobutton{Go back}}\label{conjoint_r_us}} 
    \bbvs \ip \rose{Endorsing the GCS is not determinant to gain the Democratic primary.}
    \ee
    \begin{figure}\vspace{-.4cm}
        \centering 
...
\begin{frame}{Conjoint analyses: influence on preferred platform (Germany) \hyperlink{conjoint_r_fr}{\beamergotobutton{Go back}}\label{conjoint_r_de}} 
    \bbvs \ip \rose{Endorsing the GCS is not determinant to gain the Democratic primary.}
    \ee
    \begin{figure}\vspace{-.4cm}
        \centering 
...
\begin{frame}{Conjoint analyses: influence on preferred platform (Spain) \hyperlink{conjoint_r_fr}{\beamergotobutton{Go back}}\label{conjoint_r_es}} 
    \bbvs \ip \rose{Endorsing the GCS is not determinant to gain the Democratic primary.}
    \ee
    \begin{figure}\vspace{-.4cm}
        \centering 
...
\begin{frame}{Conjoint analyses: influence on preferred platform (UK) \hyperlink{conjoint_r_fr}{\beamergotobutton{Go back}}\label{conjoint_r_uk}} 
    \bbvs \ip \rose{Endorsing the GCS is not determinant to gain the Democratic primary.}
    \ee
    \begin{figure}\vspace{-.4cm}
        \centering 
...
\begin{frame}{The distributive effects of the GCS\label{other_distributive} \hyperlink{GCS_gain}{\beamergotobutton{Go back}}}
    \begin{figure}
        \centering 
...
\begin{frame}{The distributive effects \hyperlink{GCS_gain}{\beamergotobutton{Go back}}}
    \begin{figure}
        \centering 
...
\begin{frame}{Distributive effects of the Global Climate Plan \hyperlink{GCS_gain}{\beamergotobutton{Go back}}}
    \begin{figure}
        \centering 
