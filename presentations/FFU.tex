% Négos ont échoué parce que certains pays font obstacles (Arabie Saoudite) et car pays du Sud demandent légitimement des transferts, que les pays du Nord refusent
% Or, les enquêtes montrent qu'une majorité de la population au Nord serait favorable à transferts
% Gens préfèrent pol clim à l'échelle mondiale 
% Une majorité est favorable à un plafonnement des émissions, et quand on leur demande comment partager les droits d'émissions du budget, consensus en faveur d'une répartition égalitaire
% => c'est ce qui motive à proposer un PMC
% On plafonne les émissions suivant une trajectoire déroissante conforme à l'accord de Paris
% On met aux enchères les permis d'émissions, comme ce que l'UE est en train de mettre en place mais ouvert à tous les pays volontaires
% Les recettes financent un revenu de base mondial : 50€/mois par personne, ça éradique l'extrême pauvreté
% Redistribution des émetteurs vers les frugaux; Transferts Nord-Sud importants
% Le système entre en vigueur dès qu'une masse critique de pays rejoint l'Union climatique, il y a une taxe carbone aux frontières de l'Union
% Ce PMC est soutenu par 75% des Européens et 54% des US, même quand ils comprennent qu'ils seraient financièrement perdants
% Les gens le pensent vraiment. Par ex un candidat progressiste gagnerait 11 points d'intention de vote au 2e tour en faisant campagne là-dessus; près de la moitié disent voter pour défendre les humains ou humains + animaux quand ils votent. 
% En voyant ces résultats, fondé GRA; 20 partis politiques de 10 pays différents soutiennent ce Plan et soutiennent une autre proposition: ISF mondial finançant pays du Sud
% Après discussion avec négociateurs climat des principaux pays: le Brésil soutient complètement la proposition, la Chine et l'Inde soutiennent, suis en train de rédiger une proposition de traité avec Kenya, si tous ces pays signent et que les 3/4 des européens soutiennent, ça mettra une énorme pression sur l'UE pour signer
% Il faut une mobilisation populaire, comme une grève mondiale en faveur d'une proposition de ce type
...
\begin{frame}{International surveys with a focus on the West\label{questionnaires}}
    ...
    \bbvs \ip Eu: 3,000 respondents from France, Germany, Spain, UK; 20 min.  \hyperlink{representativeness}{\beamergotobutton{Representativeness}}
...
\begin{frame}{Conjoint analyses: influence on preferred platform\label{conjoint_d}} 
    \bbvs \ip We ask the preference between two progressive platforms, where each measure is taken at random. \\ The GCS is included in one of the platforms.  \hyperlink{campaign}{\beamergotobutton{Campaign effect}}
    \ee
...
%     \ee \pause
%     \begin{table}[h]\label{tab:donation}\vspace*{-.4cm}
...
\begin{frame}{Towards an international tax system}
    \begin{figure}
        ...
        \includegraphics[width=\textwidth]{../figures/policies/global_taxes_revenues} }
...
\begin{frame}{Representativeness of complementary surveys \hyperlink{questionnaires}{\beamergotobutton{Go back}}}
    \vspace{-.6cm}
\begin{table}[h!]
...
\begin{frame}{Representativeness of \textit{Eu} surveys \hyperlink{questionnaires}{\beamergotobutton{Go back}}}
    \vspace{-.6cm}
    \begin{table}[h]
...
\begin{frame}{Campaign effect\label{campaign}}
	Presenting 3 pros and 6 cons or asking to reflect upon pros and cons reduces support.  \hyperlink{conjoint_d}{\beamergotobutton{Go back}}
    \begin{table}[h]
