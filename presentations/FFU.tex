...
\begin{frame}{The principles}
    \begin{enumerate}[<+->]
        ...
        \ip A steadily increasing \blue{carbon price floor starting at \$5/tCO$_\text{2}$} would ensure incentives to decarbonize.
        \ee
...
\\ \quad \\ \quad \\ 2-page policy note on: \blue{\href{https://bit.ly/gcp-2p}{bit.ly/gcp-2p}}
\\ \quad \\ @adrien\_fabre 
\end{frame}
