...
{ // D
	...
	if (country == "France" || country == "La France" || country == "Frankreich" || country == "Francia") {
		...
		var featurearray = {"Economía" : ["Más necesidades sanitarias dentro del sistema público (cuidado dental, gafas, salud mental)","Ingreso Básico Garantizado de 600€ al mes","Jornada laboral de 34 horas semanales","Inversión en el sistema educativo y universalización de la educación preescolar","-"],"Sociedad" : ["Reformar la ley electoral para hacer el Senado más proporcional","Abolición de la prostitución","-"],"Política climática" : ["100% de electricidad producida con energías renovables en 2040","Plano de aislamiento","Ban the sale of new combustion-engine cars by 2030","-"],"Fiscalidad" : ["Plan nacional de redistribución","Aumentar los impuestos sobre las rentas superiores a 100.000 euros anuales Y Plan nacional de redistribución"]};
