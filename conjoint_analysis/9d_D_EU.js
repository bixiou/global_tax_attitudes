...
{ // D
	...
	if (country == "France" || country == "La France" || country == "Frankreich" || country == "Francia") {
		...
		// var restrictionarray = [[["Economic issues","£150 billion to upgrade schools, hospitals, care homes and council houses"],["Tax system","National redistribution scheme"]],[["Economic issues","Re-establish neighbourhood policing and recruit 2,000 more frontline officers"],["Tax system","National redistribution scheme"]],[["UK_climate policy","Thermal insulation plan"],["Tax system","National redistribution scheme"]]];	
	}
