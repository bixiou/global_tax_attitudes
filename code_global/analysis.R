...
##### Attrition vote #####
desc_table(dep_vars = c("dropout", "dropout_late", "failed_test", "duration", "duration < 4"), weights = NULL,
...
desc_table(dep_vars = c("dropout", "dropout_late", "failed_test", "duration", "duration < 6"),weights = NULL,
