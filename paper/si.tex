...
\title{International Majorities Genuinely Support\\Global Redistributive and Climate Policies\\\textbf{Supplementary Information}}
...
\begin{table}[h]
  ...
  \begin{table}[h]
    \caption[Donation to Africa vs. own country]{Donation in case of lottery win, depending on the recipient's (randomly drawn) nationality. (Question \ref{q:donation})%\hfill (Back~to~Section~\ref{subsec:universalistic})
    } \label{tab:donation}
