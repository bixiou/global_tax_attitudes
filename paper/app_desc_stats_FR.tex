...
% \begin{center}
% {\textbf{Work in progress --- \href{https://github.com/bixiou/global_tax_attitudes/raw/main/paper/app_desc_stats_FR.pdf}{Link to most recent version}}}
% \end{center}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/understood_each.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/understood_score.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/FR/support_binary.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/gcs_important.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/FR/variables_donation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/support_likert.pdf}} 
\end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:climate_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/climate_policies.pdf}} 
% \end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:global_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/global_policies.pdf}} 
% \end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/global_tax_global_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/global_tax_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/foreign_aid_amount.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/FR/foreign_aid_raise.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/FR/foreign_aid_reduce.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/foreign_aid_raise_support.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/foreign_aid_condition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/foreign_aid_no.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/FR/variables_petition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/negotiation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/problem.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/group_defended_agg2.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/group_defended.pdf}} 
\end{figure}
...
\begin{figure}[h!] % already in text
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/points_mean.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/FR/donation_charities.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/FR/vote_agg.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/FR/survey_biased.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/share_policies_supported.pdf}} 
% \end{figure} % TODO? uncomment?

% \begin{figure}[h!]
%     \caption{label}\label{fig:vars}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/FR/vars.pdf}} 
% \end{figure}
