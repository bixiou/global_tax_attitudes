...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../figures/OECD/Heatplot_burden_share_all_positive_countries.pdf}}\label{fig:oecd_absolute}% without dependence on others (absent from OECD): Heatplot_global_tax_attitudes_positive
