...
\begin{table}[h!]
    \caption[Sample representativeness of \textit{US1}, \textit{US2}, \textit{Eu}]{Sample representativeness of the complementary surveys. (Back to \ref{subsec:data}) } \label{tab:representativeness_waves}
    \makebox[\textwidth][c]{
