...
% \footnote{Angola provides an example of a country that effectively decreased its ambition in an updated NDC, 
% % new
...
principled buyers should refuse to buy ITMOs from a country whose NDC target is above the BAU\footnote{The BAU is understood as a projection of emissions which accounts for the most recent technological developments.} 
  % current policies; see \cite{den_elzen_are_2019,unep_emissions_2025} for methodologies assessing current policies scenarios} 
...
Such incompatibility could be safely assumed when a country's NDC target exceeds both its cost-optimal emissions required to limit global warming to 2\textdegree{}C and its equal per capita share of global emissions under that 2\textdegree{}C scenario. % (thereby spanning a wide range of candidate burden-sharing rules, \citealp{van_den_berg_implications_2020}). 
Indeed, no credible burden-sharing rule could then justify the NDC's adequacy with the Paris temperature target %. This approach is in line with the literature assessing the ambition of NDCs against least-cost scenarios and equity outcomes
 \citep{van_den_berg_implications_2020,robiou_du_pont_equitable_2017,hohne_regional_2014}. % Countries affected by this additional requirement are large emitters setting unambitious NDC targets, such as China. % check if this is the case of Thailand => NICE global C&S 2°C, 1.5°C. 284/422=67% 2024-THA emissions excl. LULUCF are fossil CO2 according to EDGAR; according to Thailand: 163/278=59% of CO2 over GHG (271 non-LULUCF CO2, 163 CO2 incl. LULUCF, 386 GHG excl. LULUCF, 278 incl. LULUCF) https://unfccc.int/sites/default/files/resource/THAILAND%E2%80%99S%20BTR1.pdf; 
...
Once a large coalition of countries agree on the broad vision, this coalition could be taken as given. The coalition's emissions targets would be set below its projected emissions, with a gradually increasing wedge between current policies emissions and the target. Specifically, the 2026 target would correspond to the coalition's emissions, %the 2027 target would be slightly below the BAU, the 2028 more so, etc., realistically increasing the additional decarbonization effort overtime, TODO?
...
The resulting emission trajectory of the coalition should not exceed its equal per capita share of a global carbon budget achieving 2\textdegree{}C with a 67\% probability,\footnote{That is equivalent to 1.9\textdegree{}C with a 50\% probability \citep{forster_indicators_2025}.} and would ideally be lower. % harmonize carbon budget with above => 1.8°-50%
...
%Extra emission rights could then be allocated to countries with the lowest incomes and to those experiencing the greatest welfare loss due to the increased decarbonization effort. % with the highest marginal welfare. 
The proposed focal point can be justified by the principle that, to strengthen ambition, a country's target should not be higher than projected, committed, and \textit{fair-share} emissions at once, and by the norm that the equal right to emit per capita is the fairness benchmark. % TODO? put back? 

Given that the equal per capita share is above projected emissions % TODO!
and the NDC for some countries, the sum of focal point emissions will be lower than the coalition's emission target, and some extra emission rights will be available. To the extent that projected (and committed) emissions are far lower than the fair share in some low-income countries, and that emission reductions below the NDC are very costly for some middle-income countries, the extra rights should be allocated to these low-income or fossil-dependent countries. While the precise allocation rules need to be negotiated, I propose a specific allocation into yearly national targets in the working paper version [anonymized for review]. %\citep{fabre_global_2025}. 
...
\bibitem[{den Elzen}(2024)]{den_elzen_infographics_2024}
M.~{den Elzen}.
\newblock Infographics {{PBL NDC Tool March}} 2024, 2024.
\newblock \url{https://zenodo.org/records/10875617}.

\bibitem[{den Elzen} et~al.(2019){den Elzen}, Kuramochi, H{\"o}hne, Cantzler,
  Esmeijer, Fekete, Fransen, Keramidas, Roelfsema, Sha, {van Soest}, \&
  Vandyck]{den_elzen_are_2019}
M.~{den Elzen}, T.~Kuramochi, N.~H{\"o}hne, J.~Cantzler, K.~Esmeijer,
  H.~Fekete, T.~Fransen, K.~Keramidas, M.~Roelfsema, F.~Sha, H.~{van Soest}, \&
  T.~Vandyck.
\newblock Are the {{G20}} economies making enough progress to meet their
  {{NDC}} targets?
\newblock \emph{Energy Policy}, 2019.
\newblock
  \url{https://www.sciencedirect.com/science/article/pii/S030142151830750X}.

\bibitem[{den Elzen} et~al.(2022){den Elzen}, Dafnomilis, Forsell, Fragkos,
  Fragkiadakis, H{\"o}hne, Kuramochi, Nascimento, Roelfsema, {van Soest}, \&
  Sperling]{den_elzen_updated_2022}
M.~G.~J. {den Elzen}, I.~Dafnomilis, N.~Forsell, P.~Fragkos, K.~Fragkiadakis,
  N.~H{\"o}hne, T.~Kuramochi, L.~Nascimento, M.~Roelfsema, H.~{van Soest}, \&
  F.~Sperling.
\newblock Updated nationally determined contributions collectively raise
  ambition levels but need strengthening further to keep {{Paris}} goals within
  reach.
\newblock \emph{Mitigation and Adaptation Strategies for Global Change}, 2022.
\newblock \url{https://doi.org/10.1007/s11027-022-10008-7}.

\bibitem[{den Elzen} et~al.(2023){den Elzen}, Dafnomilis, Hof, Olsson, Beusen,
  Botzen, Kuramochi, Nascimento, \& Rogelj]{den_elzen_impact_2023}
M.~G.~J. {den Elzen}, I.~Dafnomilis, A.~F. Hof, M.~Olsson, A.~Beusen, W.~J.~W.
  Botzen, T.~Kuramochi, L.~Nascimento, \& J.~Rogelj.
\newblock The impact of policy and model uncertainties on emissions projections
  of the {{Paris Agreement}} pledges.
\newblock \emph{Environmental Research Letters}, 2023.
\newblock \url{https://doi.org/10.1088/1748-9326/acceb7}.

\bibitem[Fabre(2025)]{fabre_public_2025}
A.~Fabre.
\newblock Public {{Acceptance}} of {{International Redistribution}} in
...
\bibitem[Forster et~al.(2025)Forster, Smith, Walsh, Lamb, Lamboll, Cassou,
  Hauser, Hausfather, Lee, Palmer, {von Schuckmann}, Slangen, Szopa, Trewin,
  Yun, Gillett, Jenkins, Matthews, Raghavan, Ribes, Rogelj, Rosen, Zhang,
  Allen, Aleluia~Reis, Andrew, Betts, Borger, Broersma, Burgess, Cheng,
  Friedlingstein, Domingues, Gambarini, Gasser, G{\"u}tschow, Ishii, Kadow,
  Kennedy, Killick, Krummel, Lin{\'e}, Monselesan, Morice, M{\"u}hle, Naik,
  Peters, Pirani, Pongratz, Minx, Rigby, Rohde, Savita, Seneviratne, Thorne,
  Wells, Western, {van der Werf}, Wijffels, {Masson-Delmotte}, \&
  Zhai]{forster_indicators_2025}
P.~M. Forster, C.~Smith, T.~Walsh, W.~F. Lamb, R.~Lamboll, C.~Cassou,
  M.~Hauser, Z.~Hausfather, J.-Y. Lee, M.~D. Palmer, K.~{von Schuckmann},
  A.~B.~A. Slangen, S.~Szopa, B.~Trewin, J.~Yun, N.~P. Gillett, S.~Jenkins,
  H.~D. Matthews, K.~Raghavan, A.~Ribes, J.~Rogelj, D.~Rosen, X.~Zhang,
  M.~Allen, L.~Aleluia~Reis, R.~M. Andrew, R.~A. Betts, A.~Borger, J.~A.
  Broersma, S.~N. Burgess, L.~Cheng, P.~Friedlingstein, C.~M. Domingues,
  M.~Gambarini, T.~Gasser, J.~G{\"u}tschow, M.~Ishii, C.~Kadow, J.~Kennedy,
  R.~E. Killick, P.~B. Krummel, A.~Lin{\'e}, D.~P. Monselesan, C.~Morice,
  J.~M{\"u}hle, V.~Naik, G.~P. Peters, A.~Pirani, J.~Pongratz, J.~C. Minx,
  M.~Rigby, R.~Rohde, A.~Savita, S.~I. Seneviratne, P.~Thorne, C.~Wells, L.~M.
  Western, G.~R. {van der Werf}, S.~E. Wijffels, V.~{Masson-Delmotte}, \&
  P.~Zhai.
\newblock Indicators of {{Global Climate Change}} 2024: Annual update of key
  indicators of the state of the climate system and human influence.
\newblock \emph{Earth System Science Data}, 2025.
\newblock \url{https://essd.copernicus.org/articles/17/2641/2025/}.

\bibitem[H{\"o}hne et~al.(2014)H{\"o}hne, {den Elzen}, \&
  Escalante]{hohne_regional_2014}
N.~H{\"o}hne, M.~{den Elzen}, \& D.~Escalante.
\newblock Regional {{GHG}} reduction targets based on effort sharing: A
  comparison of studies.
\newblock \emph{Climate Policy}, 2014.
\newblock \url{https://doi.org/10.1080/14693062.2014.849452}.

\bibitem[La~Hoz~Theuer et~al.(2019)La~Hoz~Theuer, Schneider, \&
  Broekhoff]{la_hoz_theuer_when_2019}
S.~La~Hoz~Theuer, L.~Schneider, \& D.~Broekhoff.
\newblock When less is more: Limits to international transfers under
  {{Article}} 6 of the {{Paris Agreement}}.
\newblock \emph{Climate Policy}, 2019.
\newblock \url{https://doi.org/10.1080/14693062.2018.1540341}.

\bibitem[Mehling(2019)]{mehling_governing_2019}
M.~A. Mehling.
\newblock Governing {{Cooperative Approaches}} under the {{Paris Agreement}}.
\newblock \emph{Ecology Law Quarterly}, 2019.
\newblock \url{https://www.jstor.org/stable/27069892}.

\bibitem[Michaelowa et~al.(2019)Michaelowa, Hermwille, Obergassel, \&
  Butzengeiger]{michaelowa_additionality_2019}
A.~Michaelowa, L.~Hermwille, W.~Obergassel, \& S.~Butzengeiger.
\newblock Additionality revisited: Guarding the integrity of market mechanisms
  under the {{Paris Agreement}}.
\newblock \emph{Climate Policy}, 2019.
\newblock \url{https://doi.org/10.1080/14693062.2019.1628695}.

\bibitem[Nascimento et~al.(2024)Nascimento, {den Elzen}, Kuramochi, Woollands,
  Dafnomilis, Moisio, Roelfsema, Forsell, \&
  Araujo~Gutierrez]{nascimento_comparing_2024}
L.~Nascimento, M.~{den Elzen}, T.~Kuramochi, S.~Woollands, I.~Dafnomilis,
  M.~Moisio, M.~Roelfsema, N.~Forsell, \& Z.~Araujo~Gutierrez.
\newblock Comparing the {{Sequence}} of {{Climate Change Mitigation Targets}}
  and {{Policies}} in {{Major Emitting Economies}}.
\newblock \emph{Journal of Comparative Policy Analysis: Research and Practice},
  2024.
\newblock \url{https://doi.org/10.1080/13876988.2023.2255151}.

\bibitem[{Robiou du Pont} et~al.(2017){Robiou du Pont}, Jeffery, G{\"u}tschow,
  Rogelj, Christoff, \& Meinshausen]{robiou_du_pont_equitable_2017}
Y.~{Robiou du Pont}, M.~L. Jeffery, J.~G{\"u}tschow, J.~Rogelj, P.~Christoff,
  \& M.~Meinshausen.
\newblock Equitable mitigation to achieve the {{Paris Agreement}} goals.
\newblock \emph{Nature Climate Change}, 2017.
\newblock \url{https://www.nature.com/articles/nclimate3186}.

\bibitem[Rogelj et~al.(2023)Rogelj, Fransen, {den Elzen}, Lamboll, Schumer,
  Kuramochi, Hans, Mooldijk, \& {Portugal-Pereira}]{rogelj_credibility_2023}
J.~Rogelj, T.~Fransen, M.~G.~J. {den Elzen}, R.~D. Lamboll, C.~Schumer,
  T.~Kuramochi, F.~Hans, S.~Mooldijk, \& J.~{Portugal-Pereira}.
\newblock Credibility gap in net-zero climate targets leaves world at high
  risk.
\newblock \emph{Science}, 2023.
\newblock \url{https://www.science.org/doi/10.1126/science.adg6248}.

\bibitem[Steckel et~al.(2017)Steckel, Jakob, Flachsland, Kornek, Lessmann, \&
  Edenhofer]{steckel_climate_2017}
J.~C. Steckel, M.~Jakob, C.~Flachsland, U.~Kornek, K.~Lessmann, \&
  O.~Edenhofer.
\newblock From climate finance toward sustainable development finance.
\newblock \emph{WIREs Climate Change}, 2017.
\newblock \url{https://onlinelibrary.wiley.com/doi/abs/10.1002/wcc.437}.

\bibitem[{UNEP}(2025)]{unep_emissions_2025}
{UNEP}.
\newblock \emph{Emissions {{Gap Report}} 2025: {{Off Target}} - {{Continued
  Collective}} Inaction Puts {{Global Temperature Goal}} at {{Risk}}}.
\newblock UNEP, 2025.
\newblock ISBN 978-92-807-4239-8.
\newblock \url{https://wedocs.unep.org/20.500.11822/48854}.

\bibitem[{van den Berg} et~al.(2020){van den Berg}, {van Soest}, Hof, {den
  Elzen}, {van Vuuren}, Chen, Drouet, Emmerling, Fujimori, H{\"o}hne,
  K{\~o}berle, McCollum, Schaeffer, Shekhar, Vishwanathan, Vrontisi, \&
  Blok]{van_den_berg_implications_2020}
N.~J. {van den Berg}, H.~L. {van Soest}, A.~F. Hof, M.~G.~J. {den Elzen}, D.~P.
  {van Vuuren}, W.~Chen, L.~Drouet, J.~Emmerling, S.~Fujimori, N.~H{\"o}hne,
  A.~C. K{\~o}berle, D.~McCollum, R.~Schaeffer, S.~Shekhar, S.~S. Vishwanathan,
  Z.~Vrontisi, \& K.~Blok.
\newblock Implications of various effort-sharing approaches for national carbon
  budgets and emission pathways.
\newblock \emph{Climatic Change}, 2020.
\newblock \url{https://doi.org/10.1007/s10584-019-02368-y}.
