...
% TODO! add price floor to deter cartels
...
% Abstract: How can we move towards a fairer world while effectively combating climate change? The surest instrument for tackling climate change is capping greenhouse gas emissions through a system of tradable allowances. By redistributing the revenues generated equally among all human beings, this mechanism would eradicate extreme poverty. Utopia? Survey evidence shows strong support for such a "Global Climate Plan", even in high-income countries that would bear the burden.
...
The Global Climate Plan would help achieving the internationally agreed agenda for a prosperous future. While the Paris agreement sets an unanimous climate objective, it does not establish binding rules, % TODO diplomats say it is binding
and current policies place the world on track to a temperature rise of 2.7\textdegree{}C in 2100 \citep{climate_action_tracker_warming_2022}. Likewise, the Sustainable Development Goals set different targets for 2030, the first one being to eradicate extreme poverty defined as living on less than \$1.90 a day (in 2011 PPP). % TODO? \$2.15 a day (in 2017 PPP)
...
Building on insights from game theory \citep{mackay_price_2015, nordhaus_climate_2015}, the GCP should be launched by a club of willing countries, with a carbon tariff and possibly sanctions on non-participating countries, to foster compliance by most countries. 
...
% Other estimation: Leimbach & Giannousakis (19)
...
% The basic participation mechanism, which would also prevent carbon leakage, is a carbon border adjustment: non-participating countries would face a tariff on the goods they export to participating countries according to the emissions embodied in these goods (or according to a worst-case benchmark if these emissions cannot be measured). The carbon price applied to such exports would be at least equal to the market price. The governing body could decide to apply a higher price, on two grounds. First, if non-participating countries (with higher-than-average carbon footprint) joined the GCP, the GCP's carbon budget would grow less than the set of regulated emissions, so the market price of carbon would rise. The carbon price should be equal to that higher level (all over the world) to respect the carbon budget. Therefore, the carbon border adjustment could be set at (the estimated value) of that \textit{counterfactual price}, to internalize the price that participating entities would have to pay for these imported goods if the GCP was truly global and the carbon budget respected. % Yes but in the counterfactual world, the price would be uniform globally: in this proposal we don't fully internalize the higher counterfactual price as we do it only at the border. => OK but we need this higher price to fully prevent leakage. Otherwise a cartel of industries will have an incentive to outsource outside the club where emissions are not capped. The border price should not be sensitive to the location of industries. => TODO!? another possibility is to require importers to buy permits in the club, i.e. to put a ceiling on the club's carbon footprint
% Second, the governing body could decide to apply sanctions in the form of a tariff higher than the counterfactual price. 

In some federal countries like the U.S., some States may be willing to join the GCP while the federal level would not. The GCP would add provisions to help such States to join it. In particular, participating subnational entities would be allowed to opt out from levying a carbon tariff, and they may choose % would also be allowed 
...
Besides, if the governance body deems it appropriate to encourage participation, it could vote sanctions against non-participating countries, such as tariffs (beyond the carbon tariff), assets forfeiture, or travel restrictions (especially targeting elites). 
...
% Defendemos un Plan mundial por el clima y contra la pobreza extrema, detallado en nuestro informe (bit.ly/GRA_GCP, que incluye efectos distributivos entre países). 

% He aquí los principios fundamentales del Plan:
% 1.	Limitar las emisiones de acuerdo con un presupuesto de carbono predeterminado, utilizando un Régimen de Comercio de Derechos de Emisión (RCDE).
% - El plan definiría un presupuesto de carbono que se desglosaría en cuotas anuales.
% - Los permisos de emisión de CO2 se subastarían entre las empresas emisoras.
% - Alternativamente, podríamos tener un impuesto sobre el carbono en lugar de un ETS.
% - El precio del carbono animaría a hogares y empresas a descarbonizarse.
% - Los precios más altos los pagarían en última instancia los particulares en proporción a su huella de carbono.

% 2.	Utilizar los ingresos para proporcionar una renta básica mundial y aliviar la pobreza.
% - Los ingresos se devolverían al público en forma de renta básica para todos los adultos. 
% - Cada persona recibiría unos 50 dólares al mes.
% - La implementación es técnicamente posible (utilizando, por ejemplo, smartphones e internet por satélite).

% 3.	Formar un club del clima con tarificación del carbono en las fronteras
% - El plan entraría en vigor en cuanto las entidades firmantes cubrieran el 60% de las emisiones mundiales (por ejemplo, China: 30%, UE+Reino Unido: 9%, EE.UU.: 15%, y países beneficiarios netos: 23%).
% - Las importaciones a los países del club climático se gravarían en proporción a su contenido de carbono.

% 4.	Incluir mecanismos que fomenten la participación de China, California, etc. 
% - El Plan permitiría a los Estados adherirse al acuerdo independientemente del nivel federal, en particular eximiéndoles de los aranceles en frontera.
% - Una cláusula de exclusión voluntaria para la puesta en común de los ingresos permitiría a los países (como China, Sudáfrica o Argelia) cuyo PIB per cápita no supere en más de un 50% la media mundial retener los ingresos recaudados en su territorio, evitando que sean contribuyentes netos a pesar de su huella de carbono superior a la media.

% 5.	Complementar este Plan con otras medidas de justicia climática y social
% - Un impuesto mundial sobre la riqueza que financie a los países con menores ingresos para hacer frente a las responsabilidades históricas.
% - Son necesarias medidas climáticas nacionales adicionales para facilitar la descarbonización.

% El Plan supondría una redistribución del 1% del PIB mundial de los países de renta alta a los de renta baja.
% - El Plan redistribuiría de los individuos con una huella de carbono alta a aquellos con una huella baja. 
% - En su punto álgido, entre 2030 y 2050, los ingresos corresponderían aproximadamente al 5% del PIB mundial, incluido un 1% en transferencias netas entre países.
% - La renta básica sacaría de la pobreza extrema a los 700 millones de personas que viven con menos de 2 dólares al día.
% - Estas estimaciones se calcularon con el escenario central +2°C del IPCC, que implica un precio del carbono de unos 150 $/tCO2 en 2030, 200 $ en 2040, 400 $ en 2050 y cero neto en 2070.

% El Plan cuenta con un amplio apoyo de la opinión pública en los países del G20, como muestran recientes encuestas académicas (bit.ly/Fabre2023)
% - Encuestas representativas explicaron el Plan a los encuestados (haciendo hincapié en sus costes) y luego midieron el apoyo, mostrando que el 76% en Europa y el 54% en Estados Unidos apoyan el Plan.