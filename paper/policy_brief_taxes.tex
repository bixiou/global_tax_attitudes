...
Supplementary Material \\ \textit{An International Plan for Sustainable Development}
...
We model simulate the international transfers a \$10/tCO$_\text{2}$ carbon price applied to all non-LULUCF CO$_\text{2}$ emissions. At the global level, and neglecting behavioral responses, 0.33\% of the world nominal GDP would be collected. 
