...
\begin{table}[h]\label{tab:representativeness_US1}
    ...
    \makebox[\textwidth][c]{
        \resizebox*{!}{.65\textheight}{% 73 without notes cf. https://tex.stackexchange.com/questions/13809/resizing-a-table-by-textheight 
