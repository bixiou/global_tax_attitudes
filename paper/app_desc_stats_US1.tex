...
\begin{table}[h]\label{tab:representativeness_US1}
    ...
    \makebox[\textwidth][c]{
        \resizebox{.95\textwidth}{!}{% cf. https://tex.stackexchange.com/questions/10863/is-there-a-way-to-slightly-shrink-a-table-including-font-size-to-fit-within-th for a better solution using adjustbox
        \input{../tables/sample_composition/US1.tex}
        }
    }
