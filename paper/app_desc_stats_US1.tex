...
To estimate the gross cost in each country, we make a key assumption concerning the evolution of the carbon footprint per adult: that they decrease by the same proportion in each country.
