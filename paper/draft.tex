...
% aussi in prez: soutien par vote (heatmap avec US left, right, Eu left, right, far right instead of countries); replace main_by_vote by main_all_by_vote after cropping it
