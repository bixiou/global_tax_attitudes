...
% add sociodemos determinants \ref{tab:gcs_determinant} \ref{app:determinants}
% TODO! aussi in prez: soutien par vote
% treat fields and gcs_important (y.c. distinguish between supporters and opponents)
% cite Carattini, Ghassim in main text (perhaps also ISSP 19, Beiser-McGrath Bernauer 19b ); rework 2.2 (perhaps verbatim of questions in footnote?); adapt narrative; nuance "largely respected by the"; shorten Section on Sincerity?; 
...
The remainder of the paper analyzes the results from the complementary surveys in the U.S. and in Europe. % TODO! rewrite it about the content of 2.3
...
\subsubsection{Global wealth tax} % TODO! should
