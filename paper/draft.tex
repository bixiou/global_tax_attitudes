...
We also ask the preferred amount of foreign aid, after either displaying the actual amount or eliciting perceptions (Figures \ref{fig:foreign_aid_amount}--\ref{fig:foreign_aid_preferred_info}). Consistent with the literature (see Appendix \ref{subsubsec:literature_foreign_aid}), most people overestimate foreign aid. Still, for most people, the preferred amount is at least as high as the perceived one. Moreover, most of those who learn the actual amount choose a bracket at least as high as the actual one. We also ask to the respondents who prefer an increase of foreign aid (either compared to the actual amount or to their perception, depending on the random branch) how they would finance it. By far, the preferred source of funding is higher taxes on the wealthiest (Figure \ref{fig:foreign_aid_raise_how}). Similarly we ask to those who prefer a reduction how they would use the freed budget: in every country, more people choose higher spending on education or healthcare rather than lower taxes (Figure \ref{fig:foreign_aid_reduce_how}). 
