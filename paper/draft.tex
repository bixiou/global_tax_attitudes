...
\begin{figure}
  % MAJOR figure
  \caption[Relative support for various global policies]{Relative support for various global policies (percentage of \textit{somewhat} or \textit{strong support}, after excluding \textit{indifferent} answers). (See Figure \ref{fig:support_likert_positive} for the absolute support.) $n_\text{US} = n_\text{Eu} = 3,000,\, n_\text{FR} = 729,\, n_\text{DE} = 929,\, n_\text{ES} = 543,\, n_\text{UK} = 749, n_\text{US, global/national wealth tax} = 2,000$} % ; $n$ = 6,000
...
\appendix % NCCcomment
% TODO numbering of figures/tables with A
