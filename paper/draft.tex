...
% TODO!!
% If your manuscript reports the results of research with human participants, the Methods section should start with a statement:
% a)	confirming that your research complies with all relevant ethical regulations; 
% b)	naming the board and institution that approved the study protocol; 
% c)	confirming that informed consent was obtained from all human participants (or exemption of informed consent was provided by the committee that reviewed the study, along with the rationale);
% d)	disclosing information on participant compensation;
% e)	indicating whether any, all, or none of your studies were preregistered. + date/link/deviations/ 
% No statistical methods were used to pre-determine sample sizes but our sample sizes are [similar to/larger than] those reported in previous publications (ref x,y,z).
% the Methods section must include a statement on randomization and whether blinding was used
...
\section*{Author Contributions} A.F. collected and analysed the data, and drafted the questionnaire and the paper. T.D. and L.M. substantially revised the questionnaire and paper, and contributed to the conception and redaction.

\section*{Competing interests} Fabre declares that he also serves as president of Global Redistribution Advocates. % TODO!? maintain?

% TODO! Tables and Figures legend here

% TODO!! don't cite Rajan, African Union, UN, ICRICT, Concord
% TODO!! Figures must be uploaded individually, one figure per file.
% TODO!! Move Figures to Extended Data figures (maximum 10): add S46, 25, 31? Tables S1, S2?
