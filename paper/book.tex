...
Ce livre est disponible gratuitement en version PDF à l'adresse~: \href{https://github.com/bixiou/global_tax_attitudes/raw/main/paper/book.pdf}{bit.ly/livrePMC}. % TODO: new repo

Les chiffres, tableaux et graphiques de l'ouvrage sont entièrement reproductibles, à l'aide du fichier suivant~:\\ \href{https://github.com/bixiou/global_tax_attitudes/blob/main/code_global/book.R}{github.com/bixiou/global\_tax\_attitudes/blob/main/code\_global/book.R}. Ce fichier appelle d'autres fichiers du même répertoire, qui préparent les données et font tourner le modèle. Les données utilisées sont ouvertes.
