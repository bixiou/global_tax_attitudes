...
\noindent I thank the Editor and both Reviewers for their careful and constructive assessment of the manuscript. % Below we reproduce each comment in italics and provide our response underneath. Changes are highlighted in the tracked-changes version of the manuscript.
...
Done: I added after ``ambition gap'' the definition ``defined as the gap between the Paris target and the sum of NDCs'' and a citation to the UNEP Emissions Gap Report 2025.
