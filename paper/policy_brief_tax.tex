% TODO! add phase out of revenue-sharing between 0.75 and 1.25 * world GDP pc, so that China, Mexico are neutral and Brazil, Colombia, etc. are winners.
% TODO! add remedial tax: collection of tax deficit. Reading Zucman's report on tax evasion (https://www.taxobservatory.eu//www-site/uploads/2023/10/global_tax_evasion_report_24.pdf), I realize we can greatly improve our wealth tax proposal. Say the U.S. doesn't implement the global wealth tax while Spain does. Take a U.S. billionaire (e.g. Bezos - $100 billion) whose company operates in Spain (say 1% of Amazon's sales are in Spain). The U.S. could collect 10% of Bezos' fortune every year if they applied our wealth tax, but they don't: Bezos has a tax deficit of $10 billion. Spain can claim 1% of this tax deficit (the fraction corresponding to Amazon's sales in Spain), and collect $100 million in tax from Bezos. Pb: data is lacking to estimate the tax base
% TODO! Guillaumont et al. (23) on how should aid be allocated between countries
...
\begin{document}
% TODO! add conditionality on social protection. TODO? Cite Gaikwad showing that Indians are more likely to support foreign-financed climate policy if it is conditioned on gender equality by India
...
% As total wealth is 424T$ (& total income 105T$), the top 0.1% (>5M$) own 19% of all wealth
...
\paragraph{Allocating the revenues in function of the GDP per capita.} The revenues should be allocated in priority to the poorest countries. A good indicator of poverty is the poverty gap: it expresses the minimum amount that would be required to lift everyone above the poverty line. However, allocating revenues in function of the poverty gap would disincentivize countries' governments to effectively address poverty. To avoid bad incentives, it is preferable to allocate the revenues in function of a well-measured indicator correlated to the poverty gap. We propose an allocation key based on GDP per capita, according to how it predicts the poverty gap predicted in a linear regression (see more details below). 
...
\begin{figure}[b!]
  ...
  \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/policies/poverty_gap4_gdp_quadratic_full}}  % poverty_gap_gdp
\end{figure}
...
% We stand for wealth taxes to finance lower-income countries. Many officially endorse our proposal, including Oxfam International, Gabriel Zucman, Thomas Piketty, and Members of the European Parliament from The Left, the Greens, S&D and Renew. 
