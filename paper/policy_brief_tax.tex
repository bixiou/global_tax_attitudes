...
\paragraph{A progressive tax schedule.} %We define wealth as net wealth, i.e. all assets (financial, real estate, art...) net of debt. % TODO: ask Piketty/Zucman if tax on net wealth wouldn't spur leverage, and why not tax gross wealth instead
