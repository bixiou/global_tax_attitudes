% TODO! 10GtCO2 per year?; not ECOSOC (that is not operational) but a new body
...
Sub-Saharan Africa would receive 53\% of total revenues.  
Indeed, due to its high poverty gap, Sub-Saharan Africa would receive \$36 per month per capita, 4 times the global average, which would amount to 32\% of its GDP.
