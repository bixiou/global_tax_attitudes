...
% \begin{center}
% {\textbf{Work in progress --- \href{https://github.com/bixiou/global_tax_attitudes/raw/main/paper/app_desc_stats_ES.pdf}{Link to most recent version}}}
% \end{center}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/understood_each.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/understood_score.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/ES/support_binary.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/gcs_important.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/ES/variables_donation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/support_likert.pdf}} 
\end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:climate_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/climate_policies.pdf}} 
% \end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:global_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/global_policies.pdf}} 
% \end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/global_tax_global_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/global_tax_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/foreign_aid_amount.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/ES/foreign_aid_raise.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/ES/foreign_aid_reduce.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/foreign_aid_raise_support.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/foreign_aid_condition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/foreign_aid_no.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/ES/variables_petition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/negotiation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/problem.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/group_defended_agg2.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/group_defended.pdf}} 
\end{figure}
...
\begin{figure}[h!] % already in text
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/points_mean.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/ES/donation_charities.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/ES/vote_agg.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/ES/survey_biased.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/share_policies_supported.pdf}} 
% \end{figure} % TODO? uncomment?

% \begin{figure}[h!]
%     \caption{label}\label{fig:vars}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/ES/vars.pdf}} 
% \end{figure}
