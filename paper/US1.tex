...
We also test support for more realistic %other
...
\input{../tables/US1/reg_list_exp.tex}
\end{table}

% Donation addresses experimenter demand
%\subsubsection{Petition} % Addresses hypothetical bias
...
%\subsubsection{Conjoint analyses} % Addresses acquiescence bias
