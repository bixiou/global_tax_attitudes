% United Kingdom; UK/ UK/ UK/; British => French
...
% \begin{center}
% {\textbf{Work in progress --- \href{https://github.com/bixiou/global_tax_attitudes/raw/main/paper/app_desc_stats_UK.pdf}{Link to most recent version}}}
% \end{center}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/understood_each.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/understood_score.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/UK/support_binary.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/gcs_important.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/UK/variables_donation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/support_likert.pdf}} 
\end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:climate_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/climate_policies.pdf}} 
% \end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:global_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/global_policies.pdf}} 
% \end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/global_tax_global_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/global_tax_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/foreign_aid_amount.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/UK/foreign_aid_raise.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/UK/foreign_aid_reduce.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/foreign_aid_raise_support.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/foreign_aid_condition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/foreign_aid_no.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/UK/variables_petition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/negotiation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/problem.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/group_defended_agg2.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/group_defended.pdf}} 
\end{figure}
...
\begin{figure}[h!] % already in text
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/points_mean.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/UK/donation_charities.pdf}} 
\end{figure}
...
% \begin{figure}[h!]  % TODO: United Kingdom
%     \caption[Voted in last election]{Voted in last election. (Question \ref{q:vote_participation})}\label{fig:vote_participation}
%     \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/UK/vote_participation.pdf}} 
% \end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/UK/vote_agg.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/UK/survey_biased.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/share_policies_supported.pdf}} 
% \end{figure} % TODO? uncomment?

% \begin{figure}[h!]
%     \caption{label}\label{fig:vars}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/UK/vars.pdf}} 
% \end{figure}
