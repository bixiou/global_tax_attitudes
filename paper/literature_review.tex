...
\citet{allport_social_1924} was the first book on pluralistic ignorance: a shared misperception concerning others' beliefs. For example, \citet{ogorman_pluralistic_1975} showed that towards the end of the civil rights movement, 47\% of Americans believed that most white people favored segregation while only 18\% did so. %\citet{miller_pluralistic_1987} shows that pluralistic ignorance emerges because individuals believe that fear of embarrassment is a sufficient cause for their own behavior but not for the behavior of others. 
