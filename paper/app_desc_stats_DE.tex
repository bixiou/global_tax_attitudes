% Germany; DE/ DE/ DE/; German => French
...
\title{Raw results and questionnaire for Germany \\
(Complementary survey Germany) \\ 
...
% \begin{center}
% {\textbf{Work in progress --- \href{https://github.com/bixiou/global_tax_attitudes/raw/main/paper/app_desc_stats_DE.pdf}{Link to most recent version}}}
% \end{center}

\clearpage
\section{Raw results}\label{app:raw_results_DE}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/understood_each.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/understood_score.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/DE/support_binary.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/gcs_important.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/DE/variables_donation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/support_likert.pdf}} 
\end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:climate_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/climate_policies.pdf}} 
% \end{figure}

% \begin{figure}[h!]
%     \caption{label}\label{fig:global_policies}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/global_policies.pdf}} 
% \end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/global_tax_global_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/global_tax_share.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/foreign_aid_amount.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/DE/foreign_aid_raise.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/DE/foreign_aid_reduce.pdf}} 
\end{figure}

\begin{figure}[h!]
    \caption[Attitudes on the evolution of foreign aid]{Attitudes regarding the evolution of German foreign aid. (Question \ref{q:foreign_aid_raise_support})}\label{fig:foreign_aid_raise_support}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/foreign_aid_raise_support.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/foreign_aid_condition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/foreign_aid_no.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/DE/variables_petition.pdf}} 
\end{figure}

\begin{figure}[h!]
    \caption[Preferred approach for international climate negotiations]{Preferred approach of diplomats at international climate negotiations. \\ In international climate negotiations, would you prefer German diplomats to defend German interests or global justice? (Question \ref{q:negotiation})}\label{fig:negotiation}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/negotiation.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/problem.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/group_defended_agg2.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/group_defended.pdf}} 
\end{figure}
...
\begin{figure}[h!] % already in text
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/points_mean.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/DE/donation_charities.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/DE/vote_agg.pdf}} 
\end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/DE/survey_biased.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/share_policies_supported.pdf}} 
% \end{figure} % TODO? uncomment?

% \begin{figure}[h!]
%     \caption{label}\label{fig:vars}
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/DE/vars.pdf}} 
% \end{figure}
