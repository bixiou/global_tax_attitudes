...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/US2/gcs_important.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/US/support_likert.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/US2/global_tax_global_share.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/US2/global_tax_share.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/US2/foreign_aid_amount.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/US2/foreign_aid_raise.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/US2/foreign_aid_reduce.pdf}} 
% \end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/US/donation_charities.pdf}} 
% \end{figure}
...
\begin{figure}[h!]  % TODO: Eu
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/US1/political_affiliation.pdf}} 
\end{figure}

% \begin{figure}[h!]  % TODO: Eu, US2
...
%     \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/US2/political_affiliation.pdf}} 
...
\begin{figure}[h!]  % TODO: Eu
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/US1/vote_participation.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/US2/vote_participation.pdf}} 
% \end{figure}

\begin{figure}[h!]% TODO: Eu remove
    \caption[Vote in last election (US1)]{Vote in last election (US2). (Question \ref{q:vote})}\label{fig:vote}
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/US1/vote_us_comp.pdf}} 
\end{figure}

% \begin{figure}[h!]% TODO: Eu, US2
%     \caption[Vote in last election (US2)]{Vote in last election (US2). (Question \ref{q:vote})}\label{fig:vote}
%     \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/US2/vote_us_comp.pdf}} 
% \end{figure}
...
\begin{figure}[h!] % TODO: Eu replace by vote_agg
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/US1/vote_all.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=.75\textwidth]{../figures/US2/vote_all.pdf}} 
% \end{figure}
...
\begin{figure}[h!] 
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/US1/survey_biased.pdf}} 
\end{figure}
...
%     \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/US2/survey_biased.pdf}} 
% \end{figure}
