...
\hline \\[-1.8ex] 
 ...
 \textit{t} & \textit{2.07} & \textit{1.51} & \textit{2.83} & \textit{0.47} & \textit{0.20} & \textit{$-$0.39} \\  % manually added 
 \textit{95\% C.I.} & \textit{[.00; .05]} & \textit{[$-$.01; .07]} & \textit{[.03; .19]} & \textit{[$-$.05; .08]} & \textit{[$-$.07; .08]} & \textit{[$-$.09; .06]} \\ % manually added 
 \hline \\[-1.8ex] 
